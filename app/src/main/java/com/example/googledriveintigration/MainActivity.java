package com.example.googledriveintigration;
...
import com.example.gdriverestlibrary.DriveServiceHelper;
import com.example.gdriverestlibrary.GoogleDriveFileHolder;
...
import static com.example.gdriverestlibrary.DriveServiceHelper.getGoogleDriveService;

public class MainActivity extends AppCompatActivity {

    private static String ApiKey="AIzaSyD798q_VJQoslcBxeS95-fWs5f66D0ZbAU";
    private static String OAuth_Client2_0_IDs="1514780307-08d2nso8injb3bnpnprt386efp3e8v8b.apps.googleusercontent.com";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createTextFile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mDriveServiceHelper.createTextFile("textfilename.txt", "some text", ApiKey)
        ...
        createFolder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // you can provide  folder id in case you want to save this file inside some folder.
                // if folder id is null, it will save file to the root
                mDriveServiceHelper.createFolder("testDummyss", ApiKey)
                        .addOnSuccessListener(new OnSuccessListener<GoogleDriveFileHolder>() {
                            @Override
                            public void onSuccess(GoogleDriveFileHolder googleDriveFileHolder) {
                                Gson gson = new Gson();
        ...
        downloadFile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mDriveServiceHelper.downloadFile(new java.io.File(getApplicationContext().getFilesDir(), "filename.txt"), ApiKey)
